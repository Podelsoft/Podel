...
function Miniget(url, options = {}) {
    ...
    const doDownload = () => {
        ...
        if (opts.transform) {
            ...
            if (!parsed || parsed.protocol) {
                httpLib = httpLibs[(_a = parsed) === null || _a === void 0 ? void 0 : _a.protocol];
                if (!httpLib) {
    ...
    stream.abort = () => {
        ...
        aborted = true;
        stream.emit('abort');
        (_a = activeRequest) === null || _a === void 0 ? void 0 : _a.abort();
        (_b = activeDecodedStream) === null || _b === void 0 ? void 0 : _b.unpipe(stream);
